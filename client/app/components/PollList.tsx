                ...
                >
                    ...
                    </div>
                    {
                        ...
                        <div className='flex justify-end'>
                            <Button onClick={() => handleDelete(poll._id).then(router.refresh)} variant='ghost' className='rounded-full text-white hover:bg-red-500 hover:text-white hover:shadow hover:shadow-red-800'>
